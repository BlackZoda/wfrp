...
[[Rules/Skills/Evaluate\|Evaluate]] is used by consumers to identify the quality of an item (see [[Rules/Economy/Craftmanship\|Craftmanship]]). Similarly, the vendor can use [[Rules/Skills/Evaluate\|Evaluate]] to appraise coins for their echange value, or spot counterfeits. Anyone can also use Evaluate to estimate the prices of [[Rules/Economy/Rare\|Rare]] or [[Rules/Economy/Exotic\|Exotic]] items to within +/- 10%.

[[Rules/Skills/Haggle\|Haggle]] is used routinely by consumers and vendors alike, typically with [[Rules/Tests/Opposed Test\|Opposed Test]]s. Haggling is expected and most prices are marked up slightly to account for this. Winning a Haggle Test reduces the price by 10% (or possibly up to 29% with an Astounding Success (6+) or with the [[Rules/Talents/Dealmaker\|Dealmaker]] Talent). Failing a Haggle contest badly usually means the vendor distrust your coinage.