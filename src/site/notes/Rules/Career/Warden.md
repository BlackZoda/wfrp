---
{"dg-publish":true,"permalink":"/Rules/Career/Warden/"}
---
...
| ----------------------------------------------------------- | --- | ----------------- | ----------------- | --- | --- | --- | ------------------------------------------------------ | ----------------- | ----------------------------------------------------- |
| <mark style="background: #FFB86CA6;">:RaLargeHammer:</mark> |     | :RaHospitalCross: | :RaHospitalCross: |     |     |     | <mark style="background: #FFF3A3A6;">:RaShield:</mark> | :RaHospitalCross: | <mark style="background: #CACFD9A6;">:RaSkull:</mark> |
