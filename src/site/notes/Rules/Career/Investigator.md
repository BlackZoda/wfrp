---
{"dg-publish":true,"permalink":"/Rules/Career/Investigator/"}
---
...
| --- | --- | --- | --- | ----------------- | ----------------- | ----------------------------------------------------- | ----------------- | ------------------------------------------------------ | ----------------------------------------------------------- |
|     |     |     |     | :RaHospitalCross: | :RaHospitalCross: | <mark style="background: #CACFD9A6;">:RaSkull:</mark> | :RaHospitalCross: | <mark style="background: #FFF3A3A6;">:RaShield:</mark> | <mark style="background: #FFB86CA6;">:RaLargeHammer:</mark> |
