---
{"dg-publish":true,"permalink":"/Rules/Career/Watchman/"}
---
...
| ----------------- | --- | ----------------- | --- | ----------------------------------------------------- | --- | --- | ------------------------------------------------------ | ----------------------------------------------------------- | ----------------- |
| :RaHospitalCross: |     | :RaHospitalCross: |     | <mark style="background: #CACFD9A6;">:RaSkull:</mark> |     |     | <mark style="background: #FFF3A3A6;">:RaShield:</mark> | <mark style="background: #FFB86CA6;">:RaLargeHammer:</mark> | :RaHospitalCross: |
