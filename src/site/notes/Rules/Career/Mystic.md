---
{"dg-publish":true,"permalink":"/Rules/Career/Mystic/"}
---


Home: [[Rules/Class/Peasant\|Peasant]], [[Rules/Career/Career\|Career]]

Races: [[World/Races/Human\|Human]], [[World/Races/Wood Elf\|Wood Elf]]

> *You have a talent for divining the future, or for convincing others you can…*

| WS  | BS  | S   | T   | I                 | Agi                                                   | Dex               | Int                                                    | WP                                                          | Fel               |
| --- | --- | --- | --- | ----------------- | ----------------------------------------------------- | ----------------- | ------------------------------------------------------ | ----------------------------------------------------------- | ----------------- |
|     |     |     |     | :RaHospitalCross: | <mark style="background: #CACFD9A6;">:RaSkull:</mark> | :RaHospitalCross: | <mark style="background: #FFF3A3A6;">:RaShield:</mark> | <mark style="background: #FFB86CA6;">:RaLargeHammer:</mark> | :RaHospitalCross: |
...
> *‘I’ll tell you for why we have wheels on our houses: it’s because no-one likes to hear the cold truth of Morr a-coming, and if there’s one thing for sure, Morr is always a-coming. So, it ain’t because we’re cheaters, but because we are honest folk!’* – Honest Chupra, Strigany Pedlar
