---
{"dg-publish":true,"permalink":"/Rules/Career/Stevedore/"}
---
...
| ----------------- | --- | ----------------------------------------------------------- | ----------------- | ----------------- | --- | --- | ------------------------------------------------------ | ----------------------------------------------------- | --- |
| :RaHospitalCross: |     | <mark style="background: #FFB86CA6;">:RaLargeHammer:</mark> | :RaHospitalCross: | :RaHospitalCross: |     |     | <mark style="background: #FFF3A3A6;">:RaShield:</mark> | <mark style="background: #CACFD9A6;">:RaSkull:</mark> |     |
...
> *‘Look, I know we specialise in coal, but don’t fence us in, we’ll port anything if the coin’s good. So, let’s do it afore the deal porters arrive; anything goes here, mate.’* – Albert Pförtner, Coal Porter
