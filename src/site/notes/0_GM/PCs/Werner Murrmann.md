---
{"dg-publish":true,"permalink":"/0_GM/PCs/Werner Murrmann/"}
---
...
**Career Tier:** 1
**Career Path:** [[Rules/Career/Apprentice Artisan (level 1)\|Apprentice Artisan (level 1)]]
**Size:** Average
**Age:** 22
**Height:** 2.10m
**Hair:** Blonde
...
AnimalCare_advances = 3
Evaluate_advances = 3
StealthUrban_advances = 10
TradeCarpentry_advances = 5
Tot_ASA = @sum =>

# Grouped & Advanced Skills
AnimalCare = Int_current + AnimalCare_advances =>
Evaluate = Int_current + Evaluate_advances =>
StealthUrban = Ag_current + StealthUrban_advances =>
TradeCarpentry = Dex_current + TradeCarpentry_advances =>
